...
First release of `@hafidznoor/idn-finlogos`. Complete rewrite of the v1 `indo-financial-logolibrary` package. See [MIGRATION.md](./MIGRATION.md) for the v1 → v2 mapping.

### Added

- 489 SVG logos across 23 categories, source-of-truth in [`data/logos.yml`](./data/logos.yml).
- Per-logo ESM and CJS subpath imports: `import bca from '@hafidznoor/idn-finlogos/icons/bca'`.
- Raw SVG-file subpath: `import bcaUrl from '@hafidznoor/idn-finlogos/icons/bca.svg'`.
...
- **Registry**: GitHub Packages → public npm (`@hafidznoor/idn-finlogos`).
...
[Unreleased]: https://github.com/hafidznoor/idn-finlogos/compare/v2.0.0...HEAD
